...
export function getCatalogTypePluralLabel(
	type: CosmeticCatalogItem["itemType"],
) {
...
export function getCatalogStoreCurrencyIcon(
	currency: "vp" | "kingdomCredits" | "unknown",
) {
	if (currency === "vp") {
