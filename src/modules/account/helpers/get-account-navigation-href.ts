...
import { isAccountShard, type AccountShard } from '@/modules/account/account-type';
...
export function buildOnboardingReturnTo(shard: AccountShard): AccountReturnToRoute {
