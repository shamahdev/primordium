...
import type { AccountTokens, Account, AccountCookie, AccountShard } from '@/modules/account/account-type';
import { captureAccountCookies, clearAccountCookies } from '@/modules/account/helpers/manage-account-cookies';
...
export function AccountLoginWebView({ shard, onCancel, onAuthenticated }: AccountLoginWebViewProps) {
