...
export function buildBundlePrice(bundle: {
	...
	const [currencyId, amount] = Object.entries(
		bundle.TotalDiscountedCost,
	)[0] ?? [undefined, 0];
	const [, originalAmount] = Object.entries(bundle.TotalBaseCost)[0] ?? [
		undefined,
		0,
	];
	...
	return {
		...
		originalAmount: originalAmount > amount ? originalAmount : undefined,
		discountPercent:
			bundle.TotalDiscountPercent > 0 ? bundle.TotalDiscountPercent : undefined,
	};
}
